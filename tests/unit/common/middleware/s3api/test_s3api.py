...
import oioswift.common.middleware.s3api
...
from tests.unit.common.middleware.s3api.test_s3_token_middleware \
    import GOOD_RESPONSE_V2, GOOD_RESPONSE_V3
from oioswift.common.middleware.s3api.request import SigV4Request, \
    Request as S3Request
...
class TestS3Middleware(S3TestCase):
    def setUp(self):
        super(TestS3Middleware, self).setUp()
    ...
    def test_token_generation(self):
        ...
        with mock.patch('oioswift.common.middleware.s3api.'
                        'request.Request.check_signature') as mock_cs:
            status, headers, body = self.call_s3api(req)
