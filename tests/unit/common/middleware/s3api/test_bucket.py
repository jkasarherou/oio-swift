...
from oioswift.common.middleware.s3api.subresource import Owner, encode_acl, \
    ACLPublicRead
from oioswift.common.middleware.s3api.request import MAX_32BIT_INT


class TestS3Bucket(S3TestCase):
    def setup_objects(self):
        self.objects = (('rose', '2011-01-05T02:19:14.275290', 0, 303),
                        ...
                        (u'z-\u062a', '2011-01-05T02:19:14.275290', 0, 390))
