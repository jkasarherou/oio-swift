...
from oioswift.common.middleware.s3api.controllers import ServiceController, \
    BucketController, ObjectController, AclController, \
    MultiObjectDeleteController, LocationController, LoggingStatusController, \
    PartController, TaggingController, UploadController, UploadsController, \
    VersioningController, UnsupportedController, S3AclController, \
    LifecycleController, CorsController, UniqueBucketController
from oioswift.common.middleware.s3api.response import AccessDenied, \
    InvalidArgument, InvalidDigest, RequestTimeTooSkewed, Response, \
    SignatureDoesNotMatch, BucketAlreadyExists, BucketNotEmpty, \
    EntityTooLarge, OperationAborted, InternalError, NoSuchBucket, \
    NoSuchKey, PreconditionFailed, InvalidRange, MissingContentLength, \
...
class Request(swob.Request):
    ...
    def get_response(self, app, method=None, container=None, obj=None,
        ...
        we can override this method. s3api.request.Request need to just call
